...
In-hospital bowel preparation = st.selectbox("Location of bowel preparation:", options=list(location_of_bowel_preparation_options.keys()), format_func=lambda x: location_of_bowel_preparation_options[x])
...
feature_values = [ccb, last_bowel_movement_was_clear_liquid, split_dose,
                  In-hospital bowel preparation, bowel_movement_status, activity_level, education]
