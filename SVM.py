...
in_hospital_bowel_preparation = st.selectbox("In-hospital_bowel_preparation:", options=list(in_hospital_bowel_preparation_options.keys()), format_func=lambda x: in_hospital_bowel_preparationin_options[x])
